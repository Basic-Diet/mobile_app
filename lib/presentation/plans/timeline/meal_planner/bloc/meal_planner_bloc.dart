...
class MealPlannerBloc extends Bloc<MealPlannerEvent, MealPlannerState> {
  ...
  TimelineDayModel _mergeTimelineDayWithDetail(
    ...
    return TimelineDayModel(
      ...
      timelineStatus: base.timelineStatus,
      dayStatus: base.dayStatus,
      effectiveFulfillmentMode: base.effectiveFulfillmentMode,
      canShowAsPlanned: base.canShowAsPlanned,
      ...
      fulfillmentModeOverride: base.fulfillmentModeOverride,
      pickupLocationIdOverride: base.pickupLocationIdOverride,
      firstDayFulfillmentOverride: base.firstDayFulfillmentOverride,
