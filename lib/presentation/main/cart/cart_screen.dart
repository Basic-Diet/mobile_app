                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        ...
                        _PickupSelectionSection(state: state),
                        Gap(AppSize.s12.h),
                        Container(
                          margin: EdgeInsets.only(bottom: AppPadding.p12.h),
                          padding: EdgeInsetsDirectional.all(AppPadding.p16.r),
...
class _PickupSelectionSection extends StatelessWidget {
  final CartLoaded state;

  const _PickupSelectionSection({required this.state});

  @override
  Widget build(BuildContext context) {
    final branchIds = state.branchIds;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Gap(AppSize.s12.h),
          _PickupDropdown(
            label: Strings.branch.tr(),
            value: state.selectedBranchId,
            items: branchIds,
            itemLabel: (branchId) => _branchLabel(branchId),
            onChanged: (branchId) {
          ...
          Gap(AppSize.s12.h),
          _PickupDropdown(
            label: Strings.pickupWindow.tr(),
            value: state.selectedPickupWindow,
            items: windows,
            itemLabel: (window) => window.replaceAll('-', ' - '),
            onChanged: state.selectedBranchId == null
                ? null
                : (window) {
  ...
  String _branchLabel(String branchId) {
    final branchData = state.restaurantHours[branchId];
...
class _PickupDropdown extends StatelessWidget {
  final String label;
  final String? value;
