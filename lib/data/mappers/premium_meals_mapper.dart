...
extension PremiumMealResponseMapper on PremiumMealResponse? {
  PremiumMealModel toDomain() {
    return PremiumMealModel(
      ...
      descriptionAr: this?.descriptionAr ?? Constants.empty,
      descriptionEn: this?.descriptionEn ?? Constants.empty,
      sourceName: this?.sourceName ?? Constants.empty,
      sourceNameAr: this?.sourceNameAr ?? Constants.empty,
      sourceNameEn: this?.sourceNameEn ?? Constants.empty,
